...
\begin{figure}[h!]
	...
	\begin{tikzpicture}[scale=.37]
		...
		\renewcommand{\pinNamesLeft}{0/{(\invertPin{\reset}) PC6}, 1/PD0, 2/PD1, 3/PD2, 4/PD3, 5/PD4, 6/\vcc, 7/\ground, 8/{(\xtal1) PB6}, 9/{(\xtal2) PB7}, 10/PD5, 11/PD6, 12/PD7, 13/PB0} % 0 up to \pinCountPerSide-1
		\renewcommand{\pinNamesRight}{14/PB1, 15/PB2, 16/{PB3 (\mosi)}, 17/{PB4 (\miso)}, 18/{PB5 (\clock)}, 19/\avcc, 20/\aref, 21/\ground, 22/PC0, 23/PC1, 24/PC2, 25/PC3, 26/PC4, 27/PC5} % \pinCountPerSide up to 2*\pinCountPerSide-1
...
\subsection{74HC595 - 8-bit Shift Register}

\begin{figure}[h!]
	\centering
	\begin{tikzpicture}[scale=.37]
	
		\renewcommand{\icLabel}{\large 74HC595}
		...
		\end{scope}
	\end{tikzpicture}
    \caption{Schematic of the 8-bit shift register 74HC595.}
...
\subsection{74HC165 - 8-bit parrallel in, serial out register}
...
\begin{figure}[h!]
	...
	\begin{tikzpicture}[scale=.37]
		...
		\renewcommand{\icLabel}{\large 74HC165}
		...
		\end{scope}
	\end{tikzpicture}
    \caption{Schematic of the parallel in, serial out IC 74HC165.}
...
\subsection{CD4043B - CMOS Quad 3-State R/S-Latches [NOR]}

\begin{figure}[h!]
	\centering
	\begin{tikzpicture}[scale=.37]
	
		\renewcommand{\icLabel}{\large CD4043B}
		...
		\end{scope}
	\end{tikzpicture}
    \caption{Schematic of the quad 3-state R/S Latch CD4043B.}
    \label{fig:quadRSLatch}
\end{figure}

\begin{table}[h!]
    \centering
    \caption{Functional states of the quad 3-state R/S Latch CD4043B [$i \in [0, 3]$].}
